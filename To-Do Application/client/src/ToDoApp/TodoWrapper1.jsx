...
const TodoWrapper1 = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get("https://todo-app-project-zj8d.onrender.com/getAllTasks");
    ...
    const fetchUserData = async () => {
        const response = await axios.get(`https://todo-app-project-zj8d.onrender.com/getUser/${userId}`);
    ...
    const addTask = async () => {
        ...
        const response = await axios.post("https://todo-app-project-zj8d.onrender.com/addTask", data);
        const formattedTask = {
            ...response.data,
            date: task.date
        }
    ...
    const handleRemoveTask =  async (id) => {
        await axios.delete(`https://todo-app-project-zj8d.onrender.com/removeTask/${id}`);
    ...
    const handleCompletedTask = async (id) => {
        try {
            await axios.put(`https://todo-app-project-zj8d.onrender.com/removeTask/${id}/completed`);
