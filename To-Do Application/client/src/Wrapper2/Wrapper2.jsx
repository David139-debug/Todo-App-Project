...
const Wrapper2 = () => {
    ...
    return(
        ...
        <section className={styles["wrapper2"]}>
                <h1 ref={titleRef} className={styles["important-topic"]}>Working on something<br /> <span className={styles["important"]}>important</span>?</h1>
                <hr ref={lineRef} className={styles["orange-line"]}/>
                <p ref={pRef} className={styles["wrap2-topic"]}>Dont worry, we can help you to <span className={styles["organise"]}>organise</span> Yourself as best as you can!</p>
        </section>
        </>);
};
